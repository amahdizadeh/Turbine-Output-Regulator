function dx = ode_Full_WT_PID(t,x,Controller,Parameter,Disturbance)
...
delta_x =  x(1:5) - work_point;
delta_U = delta_Uss  + F * delta_x ; 

% U =  Controller.Update_ut(v_wind,x);
% delta_U(1)
omega_err = Parameter.CPC.Omega_rated - Omega;
PID = 0.63* omega_err + 0.259 * x(6); 
M_g = Mg_rated ;
theta_c = -PID; 
